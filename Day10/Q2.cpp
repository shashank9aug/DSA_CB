// Function to find the next/nearest greater element for each element of the array in left.
...
//Basically we are finding next greater element for each element in left
