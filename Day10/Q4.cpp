// Function to find the next/nearest smallest element for each element of the array in right.
...
//Basically we are finding next/nearest smallest element for each element in right 
